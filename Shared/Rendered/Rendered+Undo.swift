...
extension Rendered {
    internal class func undoIcon() -> UIImage? {
    ...
    internal class func drawUndo(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 24, height: 24), resizing: ResizingBehavior = .aspectFit) {
